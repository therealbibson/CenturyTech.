...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join CenturyTech today and discover premium tech
          </p>
        </div>
